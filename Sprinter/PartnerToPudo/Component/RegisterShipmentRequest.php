...
class RegisterShipmentRequest
{
    ...
    /**
     * @var boolean $IsDirectShipment
     */
    protected $IsDirectShipment = null;
     ...
     * @return \Konekt\Courier\Sprinter\PartnerToPudo\Component\RegisterShipmentRequest
     */
     ...
     * @return boolean
     */
    public function getIsDirectShipment()
    {
      return $this->IsDirectShipment;
    }

    /**
     * @param boolean $IsDirectShipment
     * @return \Konekt\Courier\Sprinter\PartnerToPudo\Component\RegisterShipmentRequest
     */
    public function setIsDirectShipment($IsDirectShipment)
    {
